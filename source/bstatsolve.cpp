...
static int    bstateTurningPoint          (int, int, double, double, Potential *);
static void   bstateExternalIntegral      (int, int, int, double, double, double,
                                           double, double *, Potential *);
static int    bstateInternalIntegral      (int, int, int, double, double  ,
                                           double, double *, Potential *);
static void   bstateNonlocalCorrection    (double, double, double *, Potential *);
static void   bstateRenormSpwave          (int, double, double *);
static double hankel1                     (int, double);


/**********************************************************/
/*  Search for Potential Depth for Given Binding Energy   */
/**********************************************************/
double bstateFindDepth(int n, int l, int j2, double k2, double v0, double alpha,
                       double *bw, Potential *pot)
{
...
/**********************************************************/
int bstateTurningPoint(int l, int j2, double k2, double v0, Potential *pot)
{
  double qr1,qr2;
  int i;
...
/**********************************************************/
void bstateExternalIntegral(int mx, int l, int j2, double pr1, double pr2,
                            double k2, double v0, double *bw, Potential *pot)
{
...
/**********************************************************/
int bstateInternalIntegral(int m,int l,int j2, double prm, double k2, double v0,
                           double *bw, Potential *pot)
{
...
/**********************************************************/
void bstateNonlocalCorrection(double v0, double a, double *bw, Potential *pot)
{
...
/**********************************************************/
void bstateRenormSpwave(int m, double h, double *bw)
{
   double sum = 0.0;
