...
/**********************************************************/
void HFCalcEnergy(int a, Basis *basis,
     GridData *rho, GridData *tau, GridData *d2rho, GridData *divJ, GridData *vcoul,
     Skyrme *skyrme, BCSParameter *bcs, HFEnergy *energy,
...
/*
  cout <<"Kinetic Energy     " << setw(12) << energy->kinetic << endl;
  cout <<"Volume Energy      " << setw(12) << energy->volume << endl;
  cout <<"Surface Energy     " << setw(12) << energy->surface << endl;
  cout <<"Spin-Orbit Energy  " << setw(12) << energy->spinorbit << endl;
  cout <<"Coulomb Energy     " << setw(12) << energy->coulomb << endl;
  cout <<"        direct     " << setw(12) << c1*ecd << endl;
  cout <<"        exchange   " << setw(12) << -c1*c2*ece << endl;
  cout <<"Pairing Energy     " << setw(12) << energy->pairing << endl;
  cout <<"Total Energy       " << setw(12) << energy->total << endl;
*/
}
