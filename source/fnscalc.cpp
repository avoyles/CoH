...
static double fnsLABSpec                    (double, double, double, double *, double *, double *, double, double);
static double fnsCMSSpec                    (double, double, double *, double *, double);
static void   fnsCMSNormalization           (double, double, double *, double *);
static double fnsInterpolateSigma           (double, double *);
static double fnsAverageCMSSpectrumEnergy   (double, double *, double *, double *, double);
...
/**********************************************************/
void fnsMadlandNixModel(int mcn, int ne, double *energy, double **spec, FChance *fc)
{
...
/**********************************************************/
void fnsCMSNormalization(double b1, double b2, double *sigma, double *c)
{
...
/**********************************************************/
double fnsLABSpec(double e, double ef, double tm, double *sigma, double *c1, double *c2, double s, double b)
{
...
/**********************************************************/
double fnsCMSSpec(double eps, double tm, double *c1, double *c2, double s)
{
...
/**********************************************************/
double fnsAverageCMSSpectrumEnergy(double tm, double *sigma, double *c1, double *c2, double s)
{
...
/**********************************************************/
double fnsInterpolateSigma(double e, double *sigma)
{
  double s = 0.0;
