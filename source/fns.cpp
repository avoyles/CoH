...
#undef DEBUG_EXFISS
#ifdef DEBUG_EXFISS
static void   fnsExfissCheck (int, double, double *, FNSpec *);
#endif
...
#ifdef DEBUG_EXFISS
#include <iomanip>
void fnsExfissCheck (int m, double elab, double *pf, FNSpec *fns)
{
  int n = ncl[0].ntotal;
  double *x[m], *y[m];
