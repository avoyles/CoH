...
/*      Type: no argument                                 */
/**********************************************************/
double  parmGetFactor(ParmType t)
{
...
/**********************************************************/
double  parmGetFactor(ParmType t, Particle p)
{
...
/**********************************************************/
double  parmGetFactor(ParmType t, ZAnumber za)
{
...
/**********************************************************/
double  parmGetFactor(ParmType t, ZAnumber za, Particle p)
{
...
/**********************************************************/
double  parmGetValue(ParmType t)
{
  int    k = adj.getindex(t);
...
/**********************************************************/
int     parmGetValue(ParmType t, ZAnumber za)
{
  int    k = adj.getindex(t,za);
...
/**********************************************************/
double  parmGaussianDistribution(double m, double s)
{
