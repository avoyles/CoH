...
static void   ShapeNormalVector (double, double, double, double *, MFTSystem *);
static void   ShapeNormalVectorExact (double, double, double *, PolarGLPoint *, MFTSystem *);
static double ShapeCurvature (double, double, double, MFTSystem *);
static double ShapeStretchedPolarAngle (double, double, double, double);
static double ShapeStretchedAzimuthalAngle (double, double, double);
static double ShapeHexadecapole (double, double, double, int);
...
/*   Nucleus Shape                                        */
/**********************************************************/
double FRDMShape(double theta, double phi, MFTSystem *sys)
{
...
/**********************************************************/
void ShapeNormalVector(double theta, double phi, double f, double *vec, MFTSystem *sys)
{
  ...
  // cout << setprecision(4);
  // cout << setw(12) << theta << setw(12) << phi << setw(12) << f*f*sin(theta);
  // cout << setw(12) << a[0][0] << setw(12) << a[0][1] << setw(12) << a[0][2];
  // cout << setw(12) << a[1][0] << setw(12) << a[1][1] << setw(12) << a[1][2];
  // cout << setw(12) << vec[0]  << setw(12) << vec[1]  << setw(12) << vec[2];
  // cout << setw(12) << sqrt(vec[0]*vec[0] + vec[1]*vec[1] + vec[2]*vec[2]) << endl;
}
...
/**********************************************************/
void ShapeNormalVectorExact(double theta, double phi, double *vec, PolarGLPoint *gp, MFTSystem *sys)
{
  double a[2][3];
  double eps   = sys->getEps(2);
  double gamma = sys->getGamma();
  ...
  //  cout << setw(12) << theta << setw(12) << phi << setw(12) << f*f*st;
  // cout << setw(12) << a[0][0] << setw(12) << a[0][1] << setw(12) << a[0][2];
  // cout << setw(12) << a[1][0] << setw(12) << a[1][1] << setw(12) << a[1][2];
  // cout << setw(12) << vec[0]  << setw(12) << vec[1]  << setw(12) << vec[2];
  //  cout << setw(12) << sqrt(vec[0]*vec[0] + vec[1]*vec[1] + vec[2]*vec[2]) << endl;
...
/**********************************************************/
double ShapeCurvature(double theta, double phi, double f, MFTSystem *sys)
{
...
/**********************************************************/
double ShapeHexadecapole(double u, double v, double gamma, int ctl)
{
  double cg = cos(gamma);
  double sg = sin(gamma);
...
/**********************************************************/
double ShapeStretchedPolarAngle(double a, double b, double c, double d)
{
  double x1 = 1.0 - 2.0 * a;
...
/**********************************************************/
double ShapeStretchedAzimuthalAngle(double a, double b, double d)
{
  double x1 = (1.0 + a) * d + b;
  double x2 = 1.0 + a + b * d;
  double v  = x1/x2;
