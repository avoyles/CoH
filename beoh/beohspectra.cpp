...
/*
        cout << "# " << exmean << " " << ncl[0].excitation[k0] << " " << ekmean << " " << ek << endl;
        for(int i=0 ; i<200 ; i++){
          cout << i * ncl[0].de <<" " << spl[i] <<  endl;
        }
*/
      }
...
/**********************************************************/
void specCmsToLab(const int c0, double ek, double de, double *spccms, double *spclab)
{
