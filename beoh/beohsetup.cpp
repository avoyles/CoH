...
static void    setupEnergy           (bool, System *);


/**********************************************************/
/*     Clean Parameters                                   */
/**********************************************************/
void setupClearParameter(int mc, System *sys, Pdata *pdt, GDR *gdr)
{
...
/**********************************************************/
void setupGeneralParameter(bool betacalc, System *sys)
{
...
/**********************************************************/
int setupStatModel(bool betacalc, int jmax, System *sys, Pdata *pdt)
{
...
/*     Set Energy                                         */
/**********************************************************/
void setupEnergy(bool betacalc, System *sys)
{
  ...
  if(sys->ex_total == 0.0){
    if(betacalc){
      double qbeta = mass_excess(sys->target.getZ()  ,sys->target.getA())
                   - mass_excess(sys->compound.getZ(),sys->compound.getA());
