...
/**********************************************************/
double FRDMMacroNeutronSkinEnergy(double w0, MFTSystem *sys)
{
...
/**********************************************************/
double FRDMMacroSurfaceRedistributionEnergy(double w0, MFTSystem *sys)
{
...
/**********************************************************/
double FRDMMacroVolumeRedistributionEnergy(double w0, PolarGLPoint *gp, MFTSystem *sys)
{
