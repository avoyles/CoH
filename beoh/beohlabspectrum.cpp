...
static double beohCmsSpectrumInterpolate(const int, double, double, double *);
static inline double lowfilter (double x){if(fabs(x)<eps) return 0.0; else return(x);}

/**********************************************************/
/*      Integrate Over TKE Distribution                   */
/**********************************************************/
void beohIntegCmsSpectrum(const int n, const int nc, unsigned int a, BData *bdt, double de, double *spc)
{
  double *y, *z;
  y = new double [n];
  z = new double [n];
...
/**********************************************************/
void beohLabSpectrum(const int n, double ef, int k0, double de, double *spc, double *spl)
{
  if(ef <= 0.0) return;
...
double beohLabConvert(const int n, double elsq, double efsq, double emax, double de, double *spc)
{
  double spl = 0.0;
...
/***********************************************************/
double beohCmsSpectrumInterpolate(const int n, double x, double de, double *s)
{
  double y = 0.0;
