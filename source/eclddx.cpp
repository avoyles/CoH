...
static void   ddxMainProc          (const int, const int, const int,
                                    double, double **, double **, EXSpectra *);
static int    ddxEnergyArray       (const int, const int, double, double *, EXSpectra *);
static double ddxDiscreteFraction  (const int, EXSpectra *);
static int    ddxDiscreteGamma     (int, double *, double *, double, EXSpectra *);
...
static void   ddxKalbach           (int, double, double, double, double *, double *);
static void   ddxKalbachSetParm    (void);
static double ddxKalbachAfac       (int, int, double, double, double);
...
/**********************************************************/
void eclDDX(const int nm, const int km, const int cm,
            System *sys, double **np, double **fmsd, EXSpectra *dat)
{
  try{
...
/**********************************************************/
void ddxMainProc(const int nm, const int km, const int cm, double de,
                 double **np, double **fmsd, EXSpectra *dat)
{
...
{
  double sum[cm],tot[cm],ptot = 0.0, gtot1 = 0.0, gtot2 = 0.0;
...
/**********************************************************/
int ddxEnergyArray(const int c, const int km2, double de, double *ep, EXSpectra *n)
{
  ep[0] = 0.0;
  ep[1] = de/4.0;
...
/*      Discrete Gamma-Rays                               */
/**********************************************************/
int ddxDiscreteGamma(int n, double *e, double *x, double f, EXSpectra *dat)
{
  ...
  /*** if binary reaction is separated, discrete gammas exclude
       fraction populated by particle transision */
  for(i0=0 ; i0<nlev ; i0++){
...
/**********************************************************/
void ddxKalbach(int c, double ep, double f, double p, double *ddx, double *cl)
{
  double ang[NDDX];
  ...
  double a = ddxKalbachAfac(incid,c,ep,sa,sb[c]);
...
/**********************************************************/
double ddxKalbachAfac(int a, int b, double eout, double sa, double sb)
{
