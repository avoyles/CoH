...
static double AverageAsymmetry (double, double, double, double, MFTSystem *);
static double AverageDeviation (double, double, double, double, MFTSystem *);
static double EnergyVolume (double, double, MFTSystem *);
static double EnergySurface (double, double, double, MFTSystem *);
static double EnergyCurvature (double, MFTSystem *);
static double EnergyA0 (void);
static double EnergyCoulomb (double, double, MFTSystem *);
static double EnergyVolumeRedistribution (double, double, MFTSystem *);
static double EnergyCoulombExchange (double, MFTSystem *);
static double EnergySurfaceRedistribution (double, double, double, double, MFTSystem *);
...
static double EnergyPairing (double, MFTSystem *);
...
/**********************************************************/
double AverageAsymmetry(double c1, double b1, double bv, double bs, MFTSystem *sys)
{
  double x1 = sys->asym
...
/**********************************************************/
double AverageDeviation(double c1, double b2, double b4, double delta, MFTSystem *sys)
{
...
/*   Volume Energy                                        */
/**********************************************************/
double EnergyVolume(double delta, double eps, MFTSystem *sys)
{
...
/*   Surface Energy                                       */
/**********************************************************/
double EnergySurface(double b1, double bs, double delta, MFTSystem *sys)
{
...
/*   Curvature Energy                                     */
/**********************************************************/
double EnergyCurvature(double bk, MFTSystem *sys)
{
...
/*   Coulomb Energy                                       */
/**********************************************************/
double EnergyCoulomb(double c1, double b3, MFTSystem *sys)
{
...
/**********************************************************/
double EnergyVolumeRedistribution(double c2, double br, MFTSystem *sys)
{
...
/**********************************************************/
double EnergyCoulombExchange(double c4, MFTSystem *sys)
{
...
/**********************************************************/
double EnergySurfaceRedistribution(double c5, double b1, double bs, double bw, MFTSystem *sys)
{
...
/*   Pairing Energy                                       */
/**********************************************************/
double EnergyPairing(double bs, MFTSystem *sys)
{
