...
static double ShCLambda         (const int, const int, double, double *);
static double ShCParticleNumber (const int, double, double, double *);
static double ShCIntegEnergy    (const int, double, double, double *);
static double ShCSmoothDensity  (const int, double, double, double *);

static double ShCHermite        (const int m, double);
...
double FRDMShellEnergy(MFTSystem *sys, const int np, SPEnergy *spe, SCParameter *scp)
{
  ...
  for(int n=0 ; n<np ; n++){
    ...
    cout << n <<" " <<epsn[n] << " "<<  e1 << " "  << s<< endl;
  }
  cout << esmac <<" " << z << " " << z - esmac << endl;
*/
...
/**********************************************************/
double ShCLambda(const int np, const int nmax, double g, double *ep)
{
...
/**********************************************************/
double ShCParticleNumber(const int nmax, double e, double g, double *ep)
{
  double s = 0.0;
...
/**********************************************************/
double ShCIntegEnergy(const int nmax, double ef, double g, double *ep)
{
  double s = 0.0;
  for(int i=0 ; i<nmax ; i++){
    double u = (ef - ep[i])/g;
...
/**********************************************************/
double ShCSmoothDensity(const int nmax, double ef, double g, double *ep)
{
  double s = 0.0;
  for(int i=0 ; i<nmax ; i++){
    double u = (ef - ep[i])/g;
...
/**********************************************************/
double ShCHermite(const int n, double x)
{
  double fh = 0.0;
