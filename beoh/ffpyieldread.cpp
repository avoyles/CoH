...
/**********************************************************/
void FFPReadPairs(const string fname, FissionFragmentPair *ffp)
{
  ifstream fp;
  string str, file = fname;
...
/**********************************************************/
void FFPReadExpdata(const string fname, FissionFragmentPair *ffp, double *fzn)
{
  ifstream fp;
  string str, file = fname;
