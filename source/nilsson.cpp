...
/**********************************************************/
int     nilssonFillOrbit(Particle p, int n)
{
  int nfermi,nmax;
  ShellOrbit *orb;
...
int     nilssonLevel(Particle p,int m, int mf, unsigned int a, Bstate *bst, double sep, double bmax, double fshift)
{
  double vn,vp;
...
//printf("%2d %4d:  %4d %4d %4d %e\n",p,m,bst->n,bst->l,bst->j2,bst->bind);
