...
int    parmCheckParameter  (ParmType);
int    parmCheckParameter  (ParmType, Particle);
int    parmCheckParameter  (ParmType, ZAnumber);
int    parmCheckParameter  (ParmType, ZAnumber, Particle);
double parmGetFactor       (ParmType);
double parmGetFactor       (ParmType, Particle);
double parmGetFactor       (ParmType, ZAnumber);
double parmGetFactor       (ParmType, ZAnumber, Particle);
double parmGetValue        (ParmType);
int    parmGetValue        (ParmType, ZAnumber);
