...
/**********************************************************/
void statWidthFluctuationSet(int l, int j2, int id, int lev, double tj)
{
...
void statWidthFluctuationSetT0(double tj)
{
...
/**********************************************************/
void statWidthFluctuationReset(double tsum)
{
...
/**********************************************************/
void statWidthFluctuation(double t, double den, double nu)
{
...
void wfcheck()
{
  cout << setw(7) << transum << endl;
  for(int i=0 ; i<MAX_GAUSSLEG ; i++) cout << " "<< setw(7) << w[i];
  cout << endl;
  for(int i=MAX_GAUSSLEG ; i<2*MAX_GAUSSLEG ; i++) cout << " "<< setw(7) << w[i];
  cout << endl;
}
...
/**********************************************************/
double  statMoldauer(int l, int j2, int id, int lev, double t1, double df)
{
  double sum, wfc = 1.0;
...
/**********************************************************/
double statElasticEnhancement(double t)
{
...
/**********************************************************/
double  statMoldauerCC(double t0, double t1)
{
  double sum, wfc = 1.0;
...
/*      Correlation Term                                  */
/**********************************************************/
double  statMoldauerCorrelation(double t0, double t1)
{
  double df0 = statMoldauerSystematics(t0,transum);
  double df1 = statMoldauerSystematics(t1,transum);
  ...
  //  cout << t0 << " " << t1<< " " << transum << " " << df0 <<" " <<df1 << " " << cor << endl;
...
double statMoldauerSystematics(double t, double st)
{
  if(t < 0.0) return(1.0);
