...
/*     Clean Parameters                                   */
/**********************************************************/
void setupClearParameter(int mc, System *sys, Pdata *pdt, Direct *dir,
                         Dcapt *cap, FNSpec *fns)
{
...
void setupGeneralParameter(System *sys, Pdata *pdt, Direct *dir)
{
  ...
  sys->target_level = 0;
  if(sys->excitation > 0.0){
    double eps = 0.001; // if difference is less than 1 keV
    bool found = false;
...
/**********************************************************/
int setupStatModel(int jmax, System *sys, Pdata *pdt)
{
  /*** make reaction chain */
