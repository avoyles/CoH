...
/**********************************************************/
void eclCalc(System *sys, double **pe, unsigned long nsim)
{
...
/**********************************************************/
void  eclGenerateDecayTable(int c0, int k0, const int cm, double **dlp)
{
...
/*
  ...
  for(int k1=k0 ; k1<km ; k1++){
    for(int c1=0 ; c1<cm ; c1++){
      cout << setw(5) << c0 << setw(5) << k0;
      cout << setw(5) << c1 << setw(5) << k1;
...
/*
    ...
    cout << "# " << setw(3) << n << setw(13) << mtpl[n][0] << setw(13) << dat[n].getEm() << setw(13)<< ep << endl;
    cout << "# Sum        ";
    for(int c=0 ; c<cm ; c++) cout << setw(13) << sum[c];
    cout << endl;

    cout << "# Etot       ";
    for(int c=0 ; c<cm ; c++) cout << setw(13) << tot[c];
    cout << endl;

    cout << "# Eave       ";
    for(int c=0 ; c<cm ; c++) cout << setw(13) << eav[c];
    cout << endl;
*/
  }
...
//  cout << c0 <<" " << k << " " << ktot[c0]+1 <<" " << dat[c0].pfis[k] << endl;
  }
}
