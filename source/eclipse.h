...
/*      eclipse.cpp                   */
/**************************************/
void    eclCalc                         (System *, double **, unsigned long);
void    eclAllocateMemory               (const int, const int);
void    eclDeleteAllocated              (const int, const int);
void    eclGenerateDecayTable           (int, int, const int, double **);
...
/*      ecloutput.cpp                 */
/**************************************/
void    eclOutHead                      (const int, const int, double);
void    eclOutSpectra                   (const int, const int, const int, double,  double **, EXSpectra *);
void    eclTotalSpectra                 (const int, const int, const int, double, EXSpectra *);
void    eclOutNucleusHead               (const int, const int, double **);
void    eclOutChannelHead               (const int, double);
...
/*      eclddx.cpp                    */
/**************************************/
void    eclDDX                          (const int, const int, const int, System *,
                                         double **, double **, EXSpectra *);


/**************************************/
/*      eclmc.cpp                     */
/**************************************/
void    eclMC                           (const int, const int, const int, int *, int **, double ****,
                                         double **, unsigned long, double, EXSpectra *);
