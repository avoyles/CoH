...
static double expint1(double);
static double expint2(double);
static double expint3(double);
...
static double expint3(double x)
{
...
/**********************************************************/
complex<double> expintE1(complex<double> z)
{
  const int nmax = 10;
  complex<double> p(1.0,0.0),q(0.0,0.0);
  double f = 1.0;
