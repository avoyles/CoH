...
static void   beohAddElectronSpectrum (double, double, double *, double *, double *);
static double beohEnergySpectrum      (double);
static double beohFermiFunction       (double);
...
/***********************************************************/
void beohElectronSpectrum(double q, double *rc, double *rd, Nucleus *n,
                          double *spc1, double *spc2)
{
  double *t = NULL;
  try{
...
/***********************************************************/
void beohAddElectronSpectrum(double r, double de, double *t, double *spc1, double *spc2)
{
  /*** clear work array */
...
double beohFermiFunction(double e)
{
  double f = 0.0;
