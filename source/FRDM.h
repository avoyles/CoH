...
/**********************************************************/
static const string fileFRDMShape     = "CoHFRDMShape.dat";
static const string fileFRDMBeta      = "CoHFRDMBeta.dat";
static const string fileFRDMParameter = "CoHFRDMParameter.dat";
static const string fileFRDMEnergy    = "CoHFRDMEnergy.dat";

static const string fileFRLDMShape    = "CoHFRLDMShape.dat";
static const string fileFRLDMEnergy   = "CoHFRLDMEnergy.dat";
...
/*** FRDMshape.cpp */
double FRDMShape (double, double, MFTSystem *);
...
double FRDMMacroNeutronSkinEnergy (double, MFTSystem *);
double FRDMMacroSurfaceRedistributionEnergy (double, MFTSystem *);
double FRDMMacroCurvatureEnergy (MFTSystem *);
double FRDMMacroVolumeRedistributionEnergy (double, PolarGLPoint *, MFTSystem *);
...
double FRDMAveragePairingEnergy (double, LNParameter *);
...
void FRDMPrintMacroQuantity (double , double, double, double *, double, double, double, double);
void FRDMPrintMacroEnergy (double *);
void FRDMPrintBeta (const int, double **, double);
...
/*** FRDMfileout.cpp */
void FRDMWrite3DMesh (string, PolarCoordinate *);
void FRDMWriteParameters (const int, const int, LNParameter *, SCParameter *);
void FRDMWriteEnergy (string, MFTSystem *, FRDMEnergy *);
...
/*** FRLDMfileout.cpp */
void   FRLDMWrite3DMesh (string, CylindricalCoordinate *);
void   FRLDMWriteEnergy(string, const int, const int, double, FRDMEnergy *, QSurface *, CylindricalGLPoint *);
