...
class BetaProfile{
 public:
    ...
    string  source;           // data source (GT, ENSDF, or MIX)
...
/*      beohffragenergy.cpp           */
/**************************************/
double  beohExcitationEnergyDivide (ZAnumber *, ZAnumber *, double, double);
double  beohRTDamping (const double, const double);

/**************************************/
/*      beohffragbeta.cpp             */
/**************************************/
void    beohFragmentBetaDecay (double, string);
...
/*      beohlabspectrum.cpp           */
/**************************************/
void    beohIntegCmsSpectrum (const int, const int, unsigned int, BData *, double , double *);
void    beohLabSpectrum (const int, double, int, double, double *, double *);
double  beohLabConvert (const int, double, double, double, double, double *);
...
/**************************************/
/*      beohffragdecaycalc.cpp        */
/**************************************/
void    FFPSplit (CalcMode, System *, FFragData *, const int);
