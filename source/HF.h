...
/*** skyrmeparameter.cpp */
void SkyrmeParameter (string, Skyrme *);

/*** HFpotential.cpp */
void HFInitialPotential (bool, MFTSystem *, Basis *, OneBodyPotential *, LaguerrePolynomial *, HermitePolynomial *);
...
/*** HFsolvebcs.cpp */
void HFSolveBCS (int, Basis *, BCSParameter *, SPEnergy *, double *, double *, Operator *, GridData *, GridData *, LaguerrePolynomial *, HermitePolynomial *);
...
/*** HFenergy.cpp */
void HFCalcEnergy (int, Basis *, GridData *, GridData *, GridData *, GridData *, GridData *, Skyrme *, BCSParameter *, HFEnergy *, LaguerrePolynomial *, HermitePolynomial *);

/*** HFprint.cpp */
void HFMonitor (int, double, HFEnergy *, Moment *);
...
void HFPrintDensityCalc (int, int, double, double, Basis *, double *, GridData *);
