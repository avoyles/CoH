...
static double  specTransitionParticleCont (Statcalcmode, int, int, int, int,
                                           Transmission *, double, Nucleus *, Nucleus *);
static double  specTransitionParticleDisc (Statcalcmode, int, int, int, int,
                                           Transmission *, double, Nucleus *, Nucleus *);
...
( Statcalcmode  mode,              // calc. control for sum T/Moldauer/HF
  ...
  int           id,                // index of emitting particle
  int           pcn,               // parent state parity (-1/+1)
  int           jcn,               // parent spate spin (doubled)
...
/**********************************************************/
double specLevelTransitionParticle(Statcalcmode mode, int k0, int id, int p0, int j0,
                                   Transmission *tc, Transmission *td, double q,
                                   Nucleus *n0, Nucleus *n1, double *spc, double *dlp)
{
  double x,y,sum = 0.0;
  Transmission *tp;
...
/**********************************************************/
double specTransitionParticleCont(Statcalcmode mode, int k1, int id, int pcn, int jcn,
...
/**********************************************************/
double specTransitionParticleDisc(Statcalcmode mode, int k1, int id, int pcn, int jcn,
