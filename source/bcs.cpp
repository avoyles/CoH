...
/**********************************************************/
double bcsEnergyGap(Particle p, int z, int a)
{
  double delta,deltan,deltaz;
  double c1n=0.45, c2n=1.60, c1p=0.40, c2p=1.58, alpha=0.25,
...
/*     BCS U/V Factor                                     */
/**********************************************************/
double bcsVfactor(double ef, double eb, double delta)
{
  double de = eb-ef;
...
/**********************************************************/
double bcsGapEquation(int n, double ef, double delta, Bstate *bst)
{
