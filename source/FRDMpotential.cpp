...
static double MicroAverageAsymmetry(double, MFTSystem *);
static double MicroAverageDeviation(double, MFTSystem *, double);
...
/*      FRDM Potential                                    */
/**********************************************************/
void FRDMPotential(MFTSystem *sys, Basis *basis,
                   OneBodyPotential *pot, LaguerrePolynomial *fl, HermitePolynomial *fh)
{
...
/**********************************************************/
double MicroAverageAsymmetry(double c1, MFTSystem *sys)
{
  double x1 = sys->asym
...
/**********************************************************/
double MicroAverageDeviation(double c1, MFTSystem *sys, double delta)
{
