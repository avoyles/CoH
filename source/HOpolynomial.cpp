...
/**********************************************************/
void HOPolynomials(const int nr, const int nz, Basis *basis,
...
/*
  for(int i=-f->nz ; i<=f->nz ; i++){
    cout << setw(12) << f->x[i];
    for(int n=0 ; n<f->getMsize() ; n++)  cout <<setw(12) << f->P0[n][i];
    cout << endl;
  }
  cout << endl;
  for(int i=1 ; i<=f->nz ; i++){
    cout << setw(12) << f->x[i];
    for(int n=0 ; n<f->getMsize() ; n++)  cout <<setw(12) << f->P1[n][i];
    cout << endl;
  }
*/
  delete [] x;
...
/*
  for(int l=0 ; l<=lmax ; l++){
    cout << "# Lambda  = " << l << " " << nr << " " << f->getMsize() << endl;
    for(int i=0 ; i<nr ; i++){
      cout << setw(12) << f->x[i];
      for(int n=0 ; n<f->getMsize() ; n++) cout << setw(12) << f->P0[n][l][i];
      cout << endl;
    }
    cout << endl;
    cout << endl;
